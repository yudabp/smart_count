        ...
        <div class="tab-pane stretchRight active" id="dashboard">
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="active open"> <a href="../light/dprd-k.html"><i class="zmdi zmdi-long-arrow-right zmdi-hc-fw"></i><span>DPRD Kab/Kota</span> </a>
                    </li>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <center>
                    <h2>Daftar
                <div>
                <!-- <small style="color: #00a651"> --><small>DPRD Kab/Kota</small>
                    </h2>
                </center>
                </div>
            </div>
